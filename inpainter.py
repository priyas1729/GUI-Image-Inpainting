...
class Inpainter():
    def __init__(self, gui, image, mask, patch_size=9, plot_progress=False):
        self.gui = gui
    ...
    def _plot_image(self):
        ...
        cv2.imwrite(self.gui.output_image_file, image)
        self.gui.load_image(self.gui.output_image_file)
